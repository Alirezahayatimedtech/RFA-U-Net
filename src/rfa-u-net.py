...
--- a/src/rfa-u-net.py
+++ b/src/rfa-u-net.py
@@ -93,7 +93,10 @@ def train_fold(train_loader, valid_loader, test_loader, model, criterion, optim
...
@@ -105,7 +108,47 @@ def train_fold(train_loader, valid_loader, test_loader, model, criterion, optim
...
+        model.train()
+
+    # after all epochs, best_choroid holds the highest validation score
+    return best_choroid
+
+    # (old return removed)
